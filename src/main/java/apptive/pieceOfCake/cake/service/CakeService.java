...
public interface CakeService {
    ...
    CakeResponse addTasteOption(TasteOptionRequest tasteOptionRequest);// 케이크 맛 옵션 추가
    CakeResponse addCreamOption(CreamOptionRequest creamOptionRequest);// 케이크 크림 옵션 추가
    CakeResponse addColorOption(ColorOptionRequest colorOptionRequest);// 케이크 색상 옵션 추가
    CakeResponse addEtcOption(EtcOptionRequest etcOptionRequest);// 케이크 기타 옵션 추가
