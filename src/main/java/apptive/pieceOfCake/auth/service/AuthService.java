package apptive.pieceOfCake.auth.service;

import apptive.pieceOfCake.auth.jwt.TokenProvider;
import apptive.pieceOfCake.auth.model.request.JoinRequest;
import apptive.pieceOfCake.auth.model.request.LoginRequest;
import apptive.pieceOfCake.auth.model.RefreshToken;
import apptive.pieceOfCake.auth.model.TokenDto;
import apptive.pieceOfCake.auth.model.TokenRequestDto;
import apptive.pieceOfCake.auth.repository.RefreshTokenRepository;
import apptive.pieceOfCake.member.model.Member;
import apptive.pieceOfCake.member.repository.MemberRepository;
...
public class AuthService {
    ...
    public UserResponseDto signup(JoinRequest joinRequest) {
        ...
        Member member = member.build
                joinRequest.toEntity(passwordEncoder.encode(joinRequest.getLoginPwd()));
